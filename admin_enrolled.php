...
<head>
    ...
    <link rel="stylesheet" href="admin_enrolled.css">  
    ...
    <table>
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>";
                echo "<a class='edit-btn' href='edit_enrollee.php?FormID=" . $row['FormID'] . "'>Edit</a> | ";  
                echo "<a class='delete-btn' href='delete_enrollee.php?FormID=" . $row['FormID'] . "'>Delete</a>";  
                echo "</td>";
                echo "</tr>";
            }
        } else {
